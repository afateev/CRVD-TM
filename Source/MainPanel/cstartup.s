...
__vector_table
		...
		DCD     ISR_BusFault					; 0x0008	NMI
		DCD     ISR_BusFault					; 0x000C	HardFault
		DCD     ISR_BusFault					; 0x0010	MemManage
		DCD     ISR_BusFault					; 0x0014	BusFault
		DCD     ISR_BusFault					; 0x0018	UsageFault
		DCD     0								; 0x001C
		DCD     0								; 0x0020
		DCD     0								; 0x0024
		DCD     0								; 0x0028
		DCD     ISR_BusFault					; 0x002C	SVCall
		DCD     ISR_BusFault					; 0x0030	Debug Monitor
		DCD     0								; 0x0034
		DCD     ISR_BusFault					; 0x0038	PendSV
		DCD     ISR_BusFault					; 0x003C	SysTick
		DCD     0								; 0x0040	WWDG
		DCD     0								; 0x0044	PVD
		DCD     0								; 0x0048	TAMPER
		DCD     0								; 0x004C	RTC
		...
		DCD     0								; 0x00D0	SPI2
		DCD     0								; 0x00D4	USART1
		DCD     ISR_Usart2						; 0x00D8	USART2
		DCD     ISR_Usart3						; 0x00DC	USART3
		...
		DCD     0								; 0x0110	UART4
		DCD     0								; 0x0114	UART5
		DCD     ISR_Timer6						; 0x0118	TIM6
		DCD     ISR_Timer7						; 0x011C	TIM7
