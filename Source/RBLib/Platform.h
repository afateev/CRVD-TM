...
#define RBLIB_PLATFORM_ID_STM32	11
...
namespace Rblib
{
	...
	enum Platform
	{
    	...
    	PlatformStm32 = RBLIB_PLATFORM_ID_STM32
	};
...
#elif defined STM32
  #define RBLIB_PALTFORM_AUTODETECT Rblib::PlatformStm32
  #define RBLIB_PALTFORM_AUTODETECT_ID	RBLIB_PLATFORM_ID_STM32
#else
