...
namespace Msp430f665x645x565x535x
{
	...
	/// Базовый регистр захвата сравениния для таймера A (A0).
	...
	/// Базовый регистр захвата сравениния для таймера B (A1).
	...
	/// Базовый регистр захвата сравениния для таймера C (B0).
	...
	/// Базовый регистр захвата сравениния для таймера D (A2).
