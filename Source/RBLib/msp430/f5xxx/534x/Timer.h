...
#ifndef TIMER_MSP430F534X_H
#define TIMER_MSP430F534X_H
...
namespace Msp430f534x
{
	...
	public:
        ...
        /// Базовый регистр захвата сравениния для таймера D.
	typedef TimerCaptureCompare<0x0402, 0x0412> TimerDBaseCaptureCompareReg;

	/// Класс таймера D.
	class TimerD: public TimerBase<2, 0x0410, 0x042E, 0x0420, TimerDBaseCaptureCompareReg
