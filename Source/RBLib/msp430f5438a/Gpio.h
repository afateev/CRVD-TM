...
#ifndef GPIO_MSP430F5438A_H
#define GPIO_MSP430F5438A_H
...
namespace Msp430f5438a
{
	...
	// Шаблон портов Port3, Port4, Port5, Port6, Port7, Port8, Port9, Port10, Port11
	template<unsigned int IdObj,
		PortRegisterAddresType R1,
		PortRegisterAddresType R2,
		PortRegisterAddresType R3,
	...
	public:
		...
		typedef PortsFrom3to11<3, 0x0220, 0x0222, 0x0224, 0x022A, 0x0226> Port3;
		typedef PortsFrom3to11<4, 0x0221, 0x0223, 0x0225, 0x022B, 0x0227> Port4;
		typedef PortsFrom3to11<5, 0x0240, 0x0242, 0x0244, 0x024A, 0x0246> Port5;
		typedef PortsFrom3to11<6, 0x0241, 0x0243, 0x0245, 0x024B, 0x0247> Port6;
		typedef PortsFrom3to11<7, 0x0260, 0x0262, 0x0264, 0x026A, 0x0266> Port7;
		typedef PortsFrom3to11<8, 0x0261, 0x0263, 0x0265, 0x026B, 0x0267> Port8;
		typedef PortsFrom3to11<9, 0x0280, 0x0282, 0x0284, 0x028A, 0x0286> Port9;
		typedef PortsFrom3to11<10, 0x0281, 0x0283, 0x0285, 0x028B, 0x0287> Port10;
		typedef PortsFrom3to11<11, 0x02A0, 0x02A2, 0x02A4, 0x02AA, 0x02A6> Port11;
	...
	/*! \class Gpio
		...
		<tr><td>Port10</td>	<td>	+	</td><td>	+	</td><td>		</td><td>	+	</td></tr>
		<tr><td>Port11</td>	<td>	+	</td><td>	+	</td><td>		</td><td>	+	</td></tr>
