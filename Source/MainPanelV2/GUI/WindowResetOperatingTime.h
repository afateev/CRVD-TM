...
{
public:
	Rblib::CallbackWrapper<unsigned long &> GetOperatingTimeCallback;
	Rblib::CallbackWrapper<> ResetOperatingTimeCallback;
protected:
	typedef Rblib::Font Font;
...
public:
	...
	void PrintCurValue(unsigned int y)
	{
		...
		GetOperatingTimeCallback(seconds);
